...
export default class GameSetBarman extends React.Component {
    ...
    createIngredients = () => {
        ...
        while (10 - allIngredients.length !== 0) {
            ...
            if (diferent) {
                ...
                mainIngredients = mainIngredients.filter((e) => (mainIngredients[random] !== e))
            }
        }
        this.setState({
    ...
    render() {
        const info = <p>Icons made by <a href="https://www.freepik.com/" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a> is licensed by <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank" rel="noopener noreferrer">CC 3.0 BY</a></p>
        return (<>
            {this.createBoard()}
            <Footer info={info} />
        </>
